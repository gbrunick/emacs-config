...
;; See https://stackoverflow.com/questions/10787087/
;;     https://debbugs.gnu.org/cgi/bugreport.cgi?bug=12069
;; You may still need to call
;;
;;  (url-retrieve-synchronously "http://melpa.org/packages/archive-contents")
;;
;; before list packages will work on Windows.
;;
;; This becomes unnecessary when you get to Emacs 28.1
;;
