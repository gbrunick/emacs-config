...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:box (:line-width -1 :color nil :style released-button) :foreground "#8FB28F" :background "#2B2B2B" :inherit (default)))))
 '(mode-line-buffer-id ((t (:weight bold :foreground "#F0DFAF"))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((((class color) (min-colors 88)) (:box (:line-width 2 :color "grey40" :style released-button))) (t (:inherit (highlight)))))
 '(mode-line-inactive ((t (:foreground "#5F7F5F" :background "#383838" :inherit (default)))))
 '(isearch ((t (:background "tan4"))))
 ...
 '(default ((t (:foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#DCDCCC" :background "#3F3F3F" :stipple nil :inherit nil)))))

(provide-theme 'gpb-zenburn)
